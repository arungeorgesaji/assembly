...
**Note:** Assembly supports handling requests via Command Line Interface (CLI), GitHub issues and pull request comments, as well as Slack messaging, allowing flexible integration and interaction.
