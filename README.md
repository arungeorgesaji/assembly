...
**Assembly supports requests via the command line interface (CLI), GitHub issue and pull request comments, and Slack messages, including same-thread Slack follow-ups.**
